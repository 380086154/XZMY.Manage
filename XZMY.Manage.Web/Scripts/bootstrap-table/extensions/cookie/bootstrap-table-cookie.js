...
(function ($) {
    ...
    $.extend($.fn.bootstrapTable.defaults, {
        ...
        cookieSecure: null,
        cookieIdTable: '',
        cookiesEnabled: ['bs.table.sortOrder', 'bs.table.sortName', 'bs.table.pageIndex', 'bs.table.pageList', 'bs.table.columns', 'bs.table.searchText', 'bs.table.filterControl'],
        //internal variable
        filterControls: [],
    ...
    var BootstrapTable = $.fn.bootstrapTable.Constructor,
        ...
        _onpageIndex = BootstrapTable.prototype.onpageIndex,
    ...
    BootstrapTable.prototype.initCookie = function () {
        ...
        var sortOrderCookie = getCookie(this, this.options.cookieIdTable, cookieIds.sortOrder),
            ...
            pageIndexCookie = getCookie(this, this.options.cookieIdTable, cookieIds.pageIndex),
        ...
        //pageIndex
        this.options.pageIndex = pageIndexCookie ? +pageIndexCookie : this.options.pageIndex;
        //pageSize
    ...
    BootstrapTable.prototype.onpageIndex = function () {
        _onpageIndex.apply(this, Array.prototype.slice.apply(arguments));
        setCookie(this, cookieIds.pageIndex, this.options.pageIndex);
    };
    ...
    BootstrapTable.prototype.selectPage = function (page) {
        ...
        setCookie(this, cookieIds.pageIndex, page);
    };

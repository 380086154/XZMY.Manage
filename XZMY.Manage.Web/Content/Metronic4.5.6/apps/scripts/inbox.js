var AppInbox = function () {
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["/Content/Metronic4.5.6/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: '/Content/Metronic4.5.6/global/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });

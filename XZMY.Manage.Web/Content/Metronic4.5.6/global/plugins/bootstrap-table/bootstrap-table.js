...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatRecordsPerPage: function (pageBar, totalPages) {
            ...
            return sprintf('\u6BCF\u9875\u663E\u793A %s \u884C\uFF0C\u5171 %s \u9875', pageBar, totalPages);//records per page 每页显示  
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-default reload-data' +
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push(this.options.formatRecordsPerPage(pageBar.join(''), this.totalPages));
            html.push('</span>');
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        $('#' + this.options.formId + ' select').unbind().change(function () { $('.reload-data').click(); });
        ...
        if (this.options.queryParamsType === 'limit') {
            ...
            if (this.options.pagination) {
                params.PageSize = this.options.pageSize === this.options.formatAllRows() ?
                    this.options.totalRows : this.options.pageSize;
                //params.PageIndex = this.options.pageSize === this.options.formatAllRows() ?
        ...
        params = eval('(' + (JSON.stringify(params) + JSON.stringify(formData)).replace('}{', ',') + ')');
    ...
    BootstrapTable.prototype.load = function (data) {
        ...
        //alert(this.options.sidePagination);
        //alert(this.options.sidePagination === 'server');
        if (this.options.sidePagination === 'server') {

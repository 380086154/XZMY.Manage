...
{
    [Serializable]
    public class VmSchool : ViewBase, IActionViewModel<DataModel.School.School>
    {
        #region Properties 
        ...
        public String SchoolTypeName {
            get {
                string strReturn = "";
                if (listSchoolType != null)
                {
                    foreach (var m in listSchoolType)
                    {
                        if (m.DataId == SchoolTypeId)
                        {
                            strReturn = m.Name;
                            break;
                        }
        ...
        public List<VmSchoolType> listSchoolType { get; set; }
        #endregion

        #region Extendsions

        public DataModel.School.School CreateNewDataModel()
        {
            var model = new DataModel.School.School();
            if (DataId == Guid.Empty) DataId = Guid.NewGuid();
            //model.Id = Id;
            model.Name = Name;
            model.EnglishName = EnglishName;
            model.CountryLocationId = CountryLocationId;
            model.CountryLocationName = CountryLocationName;
            model.Nature = Nature;
            model.SchoolCategoryId = SchoolCategoryId;
            model.SchoolCategoryName = SchoolCategoryName;
            model.SchoolCategoryPathName = SchoolCategoryPathName;
            model.Courses = Courses;
            model.EstablishDate = EstablishDate;
            model.TeacherCount = TeacherCount;
            model.StudentCount = StudentCount;
            model.Coordinate = Coordinate;
            model.LocationId = LocationId;
            model.LocationPathName = LocationPathName;
            model.Address = Address;
            model.SchoolDistrict = SchoolDistrict;
        ...
        public DataModel.School.School MergeDataModel(DataModel.School.School model)
        {
            model.Name = Name;
            model.EnglishName = EnglishName;
            model.CountryLocationId = CountryLocationId;

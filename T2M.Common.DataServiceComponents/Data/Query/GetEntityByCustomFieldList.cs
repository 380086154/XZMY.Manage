...
namespace T2M.Common.DataServiceComponents.Data.Impl.Query
{
    ...
    public class GetEntityByCustomFieldList<T> : MappingQuery<T>, IGetEntityByIdList<T> where T : class,IDataModel, IEntity<Guid>, new()
    {


        public GetEntityByCustomFieldList() { }
        public GetEntityByCustomFieldList(string tableName) { TableName = tableName; }
